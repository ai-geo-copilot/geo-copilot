...
最后更新：2026-06-28
外部依据核验日期：2026-06-25
前置文档：`docs/GEO项目总纲.md`、`docs/GEO实施路线与架构决策.md`、`docs/GEO架构技术栈与工具整合建议.md`

## 0. 本文件角色

本文件是“长期产品化与工作流升级”的正式补充设计，重点回答：

- 如何从当前 evidence-first 系统演进到可持续商业产品。
- LangGraph / LangChain / Pydantic AI / LlamaIndex 等外部方案该放在哪一层。
- 报告、工作流、状态、评测和 Agent 化应按什么顺序推进。

它不负责裁定当前实现状态，也不替代顶层主文档：

- 当前事实、优先级、验证结果仍以 `docs/DEVELOPMENT_STATUS.md` 为准。
- 产品定义和长期不变量以 `docs/GEO项目总纲.md` 为准。
- 正式系统分层与演进路线以 `docs/GEO实施路线与架构决策.md` 为准。
